    ...
    if param and user_id in Param and Param[user_id] == param:
        ...
        if await has_used_token_today(user_id):
            ...
            await message.reply(
                ...
                f"Next token available in **{hrs_left}h {mins_left}m** (midnight UTC).\n\n"
                f"💎 Upgrade to premium for unlimited access: @DarkEnd7"
            )
            return
